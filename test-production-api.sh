...
echo -e "\n1. Checking main production domain (pitchey.pages.dev):"
curl -s https://pitchey.pages.dev | grep -o 'pitchey-api[^"]*workers.dev' | head -1 || echo "Could not find API URL in HTML"
...
echo -e "\n==========================================="
echo "If pitchey.pages.dev still shows the old API, you need to:"
echo "1. Go to Cloudflare Dashboard -> Workers & Pages -> pitchey"
echo "2. Go to Settings -> Custom domains"
echo "3. Update pitchey.pages.dev to point to the latest deployment"
echo "   OR"
