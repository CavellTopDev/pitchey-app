...
for PITCH_ID in 162 163 2; do
    ...
    API_RESPONSE=$(curl -s "https://pitchey-production.cavelltheleaddev.workers.dev/api/pitches/public/$PITCH_ID")
...
echo "======================"
echo "✅ Latest deployment: https://d2541ce0.pitchey.pages.dev"
echo ""
echo "Test these links directly in your browser:"
echo "1. Pitch 163: https://d2541ce0.pitchey.pages.dev/pitch/163"
echo "2. Pitch 162: https://d2541ce0.pitchey.pages.dev/pitch/162"
echo "3. Pitch 2: https://d2541ce0.pitchey.pages.dev/pitch/2"
echo ""
