...
echo "   curl https://pitchey-cache-test.cavelltheleaddev.workers.dev/api/cache/stats"
echo ""
echo "2. Cache Report:"
echo "   curl https://pitchey-cache-test.cavelltheleaddev.workers.dev/api/cache/report"
echo ""
echo "3. Manual Cache Warming:"
echo "   curl -X POST https://pitchey-cache-test.cavelltheleaddev.workers.dev/api/cache/warm"
echo ""
echo "4. Test Specific Endpoint:"
echo "   curl https://pitchey-cache-test.cavelltheleaddev.workers.dev/api/pitches/browse/enhanced"
echo ""
echo "5. Reset Cache Stats:"
echo "   curl -X POST https://pitchey-cache-test.cavelltheleaddev.workers.dev/api/cache/reset"
echo ""
