-- Fixed demo accounts creation script
-- Includes both password and password_hash to satisfy database constraints
...
-- Setting both password and password_hash for compatibility

-- Alex Creator (ID: 1001)
INSERT INTO users (
    id, email, username, password, password_hash, user_type, 
    first_name, last_name, company_name, bio, email_verified, 
    created_at, updated_at
) VALUES (
    1001,
    'alex.creator@demo.com',
    'alexcreator',
    '$2a$10$X4kv7j5ZcQgSvpdvQCPWCe8XaIg5xI8cyFLvHJQGY9XMKlNgUyFWu', -- Legacy password field
    '$2a$10$X4kv7j5ZcQgSvpdvQCPWCe8XaIg5xI8cyFLvHJQGY9XMKlNgUyFWu', -- Demo123 hashed
    'creator',
    'Alex',
    'Filmmaker',
    'Independent Films',
