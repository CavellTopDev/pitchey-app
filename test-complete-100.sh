...
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}          PITCHEY v0.2 - 100% FUNCTIONALITY TEST              ${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo ""
...
NEW_PITCH=$(cat <<JSON
{
  ...
  "logline": "Testing 100% functionality",
  "genre": "action",
  "format": "feature",
...
# Delete draft pitch (create one first then delete it)
...
# Get the latest draft pitch ID from database (since response doesn't include it)
...
if [ $SUCCESS_RATE -eq 100 ]; then
  echo -e "${GREEN}🎉 PERFECT SCORE! All endpoints are working correctly! 🎉${NC}"
