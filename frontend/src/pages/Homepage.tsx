...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900/20 to-gray-900">
      {/* Navigation Header */}
      <header className="bg-black/50 backdrop-blur-md sticky top-0 z-50 border-b border-purple-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-2">
                <img src="/pitcheylogo.png" alt="Pitchey Logo" className="h-8 w-auto object-contain" />
                <span className="text-2xl font-bold text-white">Pitchey</span>
              </div>
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-800/50 border border-gray-700 rounded-lg">
                    ...
                    {userType === 'investor' && (
                      <>
                        ...
                        <span className="text-sm text-gray-300">Investor</span>
                      </>
                    )}
                    {userType === 'creator' && (
                      <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6">
              Where Stories
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400"> Find Life</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() => navigate('/marketplace')}
                className="px-8 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white text-lg font-semibold rounded-xl hover:bg-white/20 transition"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-400">Active Pitches</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-pink-400 mb-2">$2.5M</div>
              <div className="text-gray-400">Funded Projects</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">
                <TrendingUp className="inline w-8 h-8 text-purple-500 mr-2" />
                Trending Now
              </h2>
              <p className="text-gray-400">The hottest pitches gaining momentum</p>
            </div>
            <button
              onClick={() => navigate('/marketplace')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {trendingPitches.map((pitch) => (
                <div
                  ...
                  className="bg-white/5 backdrop-blur-md rounded-xl overflow-hidden border border-purple-500/20 hover:border-purple-500/40 transition cursor-pointer group"
                >
                  <div className="h-40 bg-gradient-to-br from-purple-600/20 to-pink-600/20 relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Film className="w-16 h-16 text-white/20" />
                    </div>
                    <div className="absolute top-2 right-2 bg-black/50 backdrop-blur-md px-2 py-1 rounded text-xs text-white">
                      {pitch.format}
                    </div>
                  </div>
                  <div className="p-4">
                    <h3 className="font-semibold text-white mb-1 group-hover:text-purple-400 transition">
                      {pitch.title}
                    </h3>
                    <p className="text-sm text-purple-400 mb-2">{pitch.genre}</p>
                    <p className="text-sm text-gray-400 mb-3 line-clamp-2">{pitch.logline}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400">Fresh content just added to the platform</p>
            </div>
            <button
              onClick={() => navigate('/marketplace')}
              className="text-purple-400 hover:text-purple-300 transition flex items-center gap-2"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {genres.slice(1).map((genre) => (
              <button
                ...
                className="p-6 bg-gradient-to-br from-purple-600/10 to-pink-600/10 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition text-center group"
              >
                <div className="text-xl font-semibold text-white group-hover:text-purple-400 transition">
                  {genre}
                </div>
                <div className="text-sm text-gray-400 mt-1">24 pitches</div>
              </button>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">Pitchey</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button onClick={() => navigate('/portals')} className="hover:text-purple-400 transition">Submit Pitch</button></li>
                <li><button className="hover:text-purple-400 transition">Success Stories</button></li>
                <li><button className="hover:text-purple-400 transition">Pricing</button></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-4">For Investors</h3>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button onClick={() => navigate('/marketplace')} className="hover:text-purple-400 transition">Browse Pitches</button></li>
                <li><button className="hover:text-purple-400 transition">Investment Guide</button></li>
                <li><button className="hover:text-purple-400 transition">Portfolio</button></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-4">Company</h3>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button className="hover:text-purple-400 transition">About</button></li>
                <li><button className="hover:text-purple-400 transition">Contact</button></li>
                <li><button className="hover:text-purple-400 transition">Terms & Privacy</button></li>
              </ul>
            </div>
          </div>
