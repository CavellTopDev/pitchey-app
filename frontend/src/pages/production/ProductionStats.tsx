  ...
  const loadStatsData = async () => {
    try {
      ...
      setQuickStats([
        {
          ...
          description: 'Total revenue from all projects this period'
        },
        {
          id: '2',
          ...
          icon: Film,
          color: 'text-blue-600',
          description: 'Currently active production projects'
        },
        {
          id: '3',
          title: 'Team Members',
          ...
          description: 'Total team members across all projects'
        },
        {
          id: '4',
        ...
        },
        {
          ...
          description: 'Average return on investment across projects'
        },
        {
          id: '6',
          title: 'Pitch Views',
          ...
          description: 'Total views on production company pitches'
        },
        {
          id: '7',
          ...
          description: 'Average collaboration rating from partners'
        },
        {
          id: '8',
          ...
          icon: Target,
          color: 'text-teal-600',
          description: 'Efficiency in resource utilization'
        }
      ]);

      setTrendData([
        { label: 'Jan', value: 1200000, change: 5.2 },
        { label: 'Feb', value: 1350000, change: 12.5 },
        { label: 'Mar', value: 1180000, change: -12.6 },
        { label: 'Apr', value: 1420000, change: 20.3 },
        { label: 'May', value: 1650000, change: 16.2 },
        { label: 'Jun', value: 1580000, change: -4.2 }
      ]);

      setComparisonMetrics([
        {
          title: 'Revenue vs Last Period',
          current: 2400000,
          previous: 2100000,
          unit: 'USD',
          format: 'currency'
      ...
      setKpiSummary({
        ...
        topPerformer: 'The Last Symphony',
        improvementArea: 'Resource Allocation'
      });
    } finally {
      setLoading(false);
      setRefreshing(false);
