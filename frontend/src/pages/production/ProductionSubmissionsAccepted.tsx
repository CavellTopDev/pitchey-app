  ...
  useEffect(() => {
    const fetchAcceptedSubmissions = async () => {
      try {
        ...
        const response = await fetch(`${config.API_URL}/api/submissions/accepted`, {
          headers: {
          ...
          setSubmissions([
            {
              ...
              assignedProducer: 'Michael Thompson',
              team: ['Director: Sofia Martinez', 'DoP: James Wilson', 'Editor: Alex Chen']
            },
            {
              id: '11',
              ...
              acceptedDate: '2024-11-10',
              genre: 'Thriller',
              budget: 3500000,
              status: 'accepted',
              rating: 5,
              synopsis: 'A cybersecurity analyst uncovers a conspiracy that reaches the highest levels of government.',
              attachments: 8,
              lastActivity: '2 hours ago',
              reviewNotes: 'Strong commercial appeal, topical subject matter',
              productionStatus: 'production',
              productionStartDate: '2024-11-25',
              estimatedCompletion: '2025-06-15',
              productionProgress: 45,
              contractStatus: 'signed',
              assignedProducer: 'Sarah Kim',
              team: ['Director: David Foster', 'DoP: Maria Santos', 'Editor: Tom Baker', 'Sound: Lisa Park']
            },
            {
              id: '12',
              title: 'The Memory Keeper',
              creator: 'Isabella Foster',
              creatorEmail: 'isabella@example.com',
              ...
              status: 'accepted',
              rating: 4,
              synopsis: 'In a future where memories can be stored externally, a keeper of memories fights to preserve humanity\'s past.',
              attachments: 6,
              lastActivity: '1 day ago',
              reviewNotes: 'Unique premise with broad appeal',
              productionStatus: 'post-production',
              productionStartDate: '2024-10-30',
              estimatedCompletion: '2025-03-20',
              productionProgress: 85,
              contractStatus: 'signed',
              assignedProducer: 'Carlos Rodriguez',
              team: ['Director: Anna Kim', 'DoP: Mark Johnson', 'Editor: Rachel Green', 'VFX: Digital Dreams Studio']
            },
            {
              id: '13',
              title: 'Golden Hour',
              creator: 'Thomas Wright',
              creatorEmail: 'thomas@example.com',
              submittedDate: '2024-08-10',
              acceptedDate: '2024-09-05',
              genre: 'Drama',
              budget: 1800000,
              status: 'accepted',
              rating: 5,
              synopsis: 'An elderly photographer embarks on a final journey to capture the perfect sunset.',
              attachments: 5,
              lastActivity: '3 days ago',
              reviewNotes: 'Beautifully crafted, festival circuit potential',
              productionStatus: 'completed',
              productionStartDate: '2024-09-15',
              estimatedCompletion: '2024-12-10',
              productionProgress: 100,
              contractStatus: 'signed',
              assignedProducer: 'Jessica Chen',
              team: ['Director: Robert Lee', 'DoP: Emma Wilson', 'Editor: Sarah Davis']
            }
          ]);
        }
      } catch (error) {
