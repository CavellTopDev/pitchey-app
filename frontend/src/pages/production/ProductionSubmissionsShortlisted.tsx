  ...
  useEffect(() => {
    const fetchShortlistedSubmissions = async () => {
      try {
        ...
        const response = await fetch(`${config.API_URL}/api/submissions/shortlisted`, {
          headers: {
          ...
          setSubmissions([
            {
              ...
              shortlistReason: 'Unique concept with broad appeal, experienced creator',
            ...
            },
            {
              ...
              shortlistedDate: '2024-12-03',
              genre: 'Sci-Fi',
              budget: 5200000,
              status: 'shortlisted',
              rating: 5,
              synopsis: 'Humanity\'s first colony ship discovers they\'re not alone in the universe.',
              attachments: 9,
              lastActivity: '1 day ago',
              reviewNotes: 'Ambitious scope, excellent world-building',
              shortlistReason: 'High production value, timely themes, strong franchise potential',
              marketPotential: 'high',
            ...
            },
            {
              ...
              shortlistedDate: '2024-12-02',
              genre: 'Drama',
              budget: 2100000,
              status: 'shortlisted',
              rating: 4,
              synopsis: 'An artist with dementia struggles to complete her masterpiece before losing her memories.',
              attachments: 5,
              lastActivity: '2 days ago',
              reviewNotes: 'Emotional depth, award-winning potential',
              shortlistReason: 'Critical acclaim potential, strong character development',
            ...
            },
            {
              ...
              shortlistedDate: '2024-12-01',
              genre: 'Action',
              budget: 4800000,
              status: 'shortlisted',
              rating: 4,
              synopsis: 'A cybersecurity expert must stop a hacker group from triggering a global financial collapse.',
              attachments: 6,
              lastActivity: '4 hours ago',
              reviewNotes: 'Timely subject matter, high-octane sequences',
              shortlistReason: 'Market demand for cyber-thrillers, strong action sequences',
              marketPotential: 'high',
              competitionLevel: 'medium',
