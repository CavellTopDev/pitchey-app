...
export default function ProductionProjectsPost() {
  ...
  const fetchPostProductionProjects = async () => {
    try {
      setLoading(true);
    const response = await fetch(`${API_URL}/api/production/projects?status=post_production`, {
      method: 'GET',
      ...
      setProjects([
        {
          ...
          vfxProgress: 30,
          totalRuntime: 142,
          deliveryFormat: ['4K Digital', 'IMAX', 'Streaming'],
          clientApprovals: {
            roughCut: true,
            fineCut: false,
        ...
        },
        {
          ...
          vfxProgress: 100,
          totalRuntime: 118,
          deliveryFormat: ['Digital', 'Theatrical'],
          clientApprovals: {
            roughCut: true,
            fineCut: true,
        ...
        },
        {
          ...
          vfxProgress: 100,
          totalRuntime: 95,
          deliveryFormat: ['Digital', 'Streaming'],
          clientApprovals: {
            roughCut: true,
            fineCut: true,
            colorCorrection: true,
