      ...
      setActivities([
        {
          ...
          description: 'Sarah Johnson viewed "Midnight Heist" pitch',
        ...
        },
        {
          ...
          description: 'Michael Chen requested NDA access to "The Last Symphony"',
        ...
        },
        {
          ...
          description: '"Urban Legends" entered post-production phase',
        ...
        },
        {
          ...
          description: 'Director Emma Wilson joined "Starlight Dreams" project',
        ...
        },
        {
          ...
          description: 'Silver Screen Studios proposed collaboration on "Ocean Quest"',
