  ...
  useEffect(() => {
    const fetchRejectedSubmissions = async () => {
      try {
        ...
        const response = await fetch(`${config.API_URL}/api/submissions/rejected`, {
          headers: {
          ...
          setSubmissions([
            {
              ...
              rejectionReason: 'Too similar to existing projects in our pipeline',
              rejectionCategory: 'content',
              feedback: 'While the concept shows promise, we already have several time-travel themed projects in development. Consider a more unique angle or different setting.',
              canResubmit: true,
              rejectedBy: 'Sarah Kim'
            },
            {
              id: '14',
              ...
              status: 'rejected',
              rating: 3,
              synopsis: 'An intergalactic war threatens the existence of multiple civilizations.',
              attachments: 7,
              lastActivity: '2 weeks ago',
              rejectionReason: 'Budget requirements exceed our current capacity',
              rejectionCategory: 'budget',
              feedback: 'Impressive scope and vision, but the requested budget is beyond our current production capabilities. Consider scaling down or finding additional financing.',
              canResubmit: true,
              rejectedBy: 'Michael Thompson'
            },
            {
              id: '15',
              title: 'Dark Alley Chronicles',
              creator: 'Alex Turner',
              creatorEmail: 'alex.turner@example.com',
              submittedDate: '2024-11-05',
              rejectedDate: '2024-11-20',
              genre: 'Crime',
              budget: 2200000,
              status: 'rejected',
              rating: 2,
              synopsis: 'A detective investigates a series of murders in the city\'s underground.',
              attachments: 4,
              lastActivity: '3 weeks ago',
              rejectionReason: 'Content concerns and market saturation',
              rejectionCategory: 'market',
              feedback: 'The crime thriller market is currently oversaturated. The script also needs significant development in character motivation and plot structure.',
              canResubmit: false,
              rejectedBy: 'Jane Doe'
            },
            {
              ...
              rejectedDate: '2024-11-15',
              genre: 'Horror',
              budget: 1500000,
              status: 'rejected',
              rating: 1,
              synopsis: 'A family moves into a haunted house with mirrors that show alternate realities.',
              attachments: 3,
              lastActivity: '1 month ago',
              rejectionReason: 'Quality concerns with script and production plan',
              rejectionCategory: 'quality',
              feedback: 'The script requires substantial revision. Plot holes and inconsistent character development make it unsuitable for production at this time.',
              canResubmit: true,
              rejectedBy: 'Carlos Rodriguez'
            }
          ]);
        }
      } catch (error) {
