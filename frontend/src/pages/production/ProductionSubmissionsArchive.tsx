          ...
          setSubmissions([
            {
              ...
              rating: 5,
              synopsis: 'Two strangers connect through handwritten letters left in a library book.',
              attachments: 8,
              lastActivity: '3 months ago',
              archiveReason: 'Project completed successfully',
              notes: 'Festival circuit release, critical acclaim received',
              archivedBy: 'Michael Thompson',
              tags: ['completed', 'festival', 'award-winner'],
              totalViews: 245
            },
            {
              id: '18',
              ...
              creator: 'David Park',
              creatorEmail: 'david.park@example.com',
              submittedDate: '2024-05-10',
              archivedDate: '2024-08-15',
              genre: 'Sci-Fi',
              budget: 5500000,
              originalStatus: 'shortlisted',
              finalStatus: 'cancelled',
              rating: 4,
              synopsis: 'In a future where robots have consciousness, one android fights for freedom.',
              attachments: 12,
              lastActivity: '4 months ago',
              archiveReason: 'Budget constraints and market changes',
              notes: 'Strong concept but production costs exceeded projected returns',
              archivedBy: 'Sarah Kim',
              tags: ['cancelled', 'budget-issues', 'sci-fi'],
              totalViews: 189
            },
            {
              id: '19',
              ...
              archivedDate: '2024-07-30',
              genre: 'Romance',
              budget: 1800000,
              originalStatus: 'review',
              finalStatus: 'expired',
              rating: 3,
              synopsis: 'A antique shop owner discovers love letters from the 1940s and seeks their author.',
              attachments: 5,
              lastActivity: '5 months ago',
              archiveReason: 'Submission period expired without decision',
              notes: 'Creator did not respond to revision requests within deadline',
              archivedBy: 'Jane Doe',
            ...
            },
            {
              ...
              archivedDate: '2024-06-10',
              genre: 'Thriller',
              budget: 3200000,
              originalStatus: 'rejected',
              finalStatus: 'archived',
              rating: 2,
              synopsis: 'A whistleblower exposes corruption in a multinational corporation.',
              attachments: 7,
              lastActivity: '6 months ago',
              archiveReason: 'Final rejection - no resubmission allowed',
              notes: 'Legal concerns regarding real-world implications',
              archivedBy: 'Carlos Rodriguez',
              tags: ['rejected', 'legal-issues', 'final'],
              totalViews: 98
            },
            {
              id: '21',
              title: 'Ocean Depths',
              creator: 'Rachel Marine',
              creatorEmail: 'rachel@example.com',
              ...
              finalStatus: 'completed',
              rating: 4,
              synopsis: 'Deep sea explorers discover an ancient civilization beneath the Pacific.',
              attachments: 15,
              lastActivity: '7 months ago',
              archiveReason: 'Production completed, theatrical release scheduled',
              notes: 'Successful production, sequel discussions ongoing',
              archivedBy: 'Jessica Chen',
              tags: ['completed', 'theatrical', 'sequel-potential'],
              totalViews: 312
            }
          ]);
        }
