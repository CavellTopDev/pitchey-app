/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d11397a2ebb4e813e801bcb490208a2d)
// Runtime types generated with workerd@1.20251210.0 2024-01-01 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-integrated");
		durableNamespaces: "NotificationHub" | "WebSocketRoom";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		REDIS_DB: string;
		WS_RATE_LIMIT_ENABLED: string;
		WS_RATE_LIMIT_MAX_MESSAGES: string;
		WS_RATE_LIMIT_WINDOW_MS: string;
		WS_RATE_LIMIT_REFILL_RATE: string;
		WS_ANALYTICS_ENABLED: string;
		WS_PRESENCE_TRACKING_ENABLED: string;
		WS_MESSAGE_QUEUE_ENABLED: string;
		WS_HEARTBEAT_INTERVAL: string;
		WS_CLEANUP_INTERVAL: string;
		WS_SESSION_TIMEOUT: string;
		R2_ENDPOINT: string;
		...
		NOTIFICATION_HUB: DurableObjectNamespace<import("./src/worker-integrated").NotificationHub>;
		WEBSOCKET_ROOMS: DurableObjectNamespace<import("./src/worker-integrated").WebSocketRoom>;
		...
		CONTAINER_ANALYTICS: AnalyticsEngineDataset;
		JOB_ANALYTICS: AnalyticsEngineDataset;
		PITCHEY_ANALYTICS: AnalyticsEngineDataset;
		PITCHEY_PERFORMANCE: AnalyticsEngineDataset;
		PITCHEY_ERRORS: AnalyticsEngineDataset;
		TRACE_ANALYTICS: AnalyticsEngineDataset;
		VIDEO_PROCESSING_QUEUE: Queue;
		DOCUMENT_PROCESSING_QUEUE: Queue;
		AI_INFERENCE_QUEUE: Queue;
		MEDIA_TRANSCODING_QUEUE: Queue;
		CODE_EXECUTION_QUEUE: Queue;
